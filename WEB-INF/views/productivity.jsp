...
<body onload="loadDashboard()">
	<div class="app-container">
	  <div class="sidebar">
	    <div class="sidebar-header">
	      <div class="app-icon">
	       <img src="   https://cdn-icons-png.flaticon.com/512/1838/1838365.png " width="256" height="256" alt="" title="" class="logo-img">
	</div>
    ...
    <div class="card">
      ...
      <li class="sidebar-list-item">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="Teal" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
          <span class="blue-span" onclick="loadtaskslist()">Tasks</span>
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <div class="dropdown">
    <span class="username" style="color:black;">John Doe</span>
